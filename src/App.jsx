...
// SyncBase v1.4 — RAID Log, Import, Activity Feed, Comments, RACI
          ...
          <div style={{ display: "grid", gridTemplateColumns: "260px 1fr", gap: 16, marginBottom: 20 }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12 }}>
              {[
                ...
                { l: "Stakeholder Sync", v: `${proj.stakeholders.filter(s => s.syncStatus === "synced").length}/${proj.stakeholders.length}`, s: staleStakeholders > 0 ? `${staleStakeholders} ${staleStakeholders === 1 ? "needs" : "need"} update` : "all synced", c: staleStakeholders > 0 ? "#d97706" : "#059669" },
              ].map((m, i) => (
